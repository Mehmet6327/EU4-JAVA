...
public class Question14 {
	...
	/*	Question-14
	 ...
	 "Invalid data!" and stop the program (use System.exit(0) after 
		...
		Then ask the customer about his age. Display message: "How old are you?".
		     If age is less than 16, display the message: "Invalid data!",
		...
		Make sure that experience is greater than 0 and the result of subtraction age from experience is greater or equals to 16. 
		If no, display the message: 
			"Invalid data!" and stop the program.
		...
		in order to get information about the amount of accidents. 
		...
		Then ask the user about the level of education. Display message: 
			"What is the highest level of education you have completed?".
		     If the level of education equals to "Ph.D." or 
		     "Bachelors" or "Masters" - reduce the premium by 5%.
		     If the level of education equals "Doctors" reduce the premium by 10%.
	 If the level of education equals "Less than High School" increase the premiu by 5%.
		...
		zip code, and level of education without spaces. 
       ...
       int premium = 0;
		...
		if(drLic.equalsIgnoreCase("Yes")) {
			...
			if(b.equalsIgnoreCase("Business")) {
				premium+=50;
			}else if(b.equalsIgnoreCase("Pleasure")) {
				premium+=10;
			}else if(b.equalsIgnoreCase("Commute")) {
				premium-=20;
			}
			...
			System.out.println("Reference number: "+(name.substring(0,2)+age+
					name.substring(name.length()-2,name.length())+zipCode+levelEduc).toUpperCase());	
