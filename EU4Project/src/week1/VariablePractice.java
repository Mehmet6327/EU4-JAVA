...
public class VariablePractice {
	...
	public static void main(String[] args) {
		...
		// use first letter upprecase for your classaname
		...
		//Be carefull, Bear Should't injest large fluffy dog.
 ...
 double pi= 3.143265426745236745236754d; // add D or d to make it obvious that 
                                  // this is a double
