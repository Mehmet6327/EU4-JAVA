...
public class primitiveVariables {
	...
	public static void main(String[] args) {
		 ...
		 //Floating Numbers : defualt is double
		 float f1 = 2.1f;
         ...
         System.out.println("He is 16, can he take driver licence? : " + status);
